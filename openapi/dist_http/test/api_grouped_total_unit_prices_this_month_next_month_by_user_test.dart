...
void main() {
  // final instance = APIGroupedTotalUnitPricesThisMonthNextMonthByUser();

  group('test APIGroupedTotalUnitPricesThisMonthNextMonthByUser', () {
    // List<String> chargerDeviceCodes (default value: const [])
    ...
    // List<APIMonthPrice> monthPrices (default value: const [])
